// import { BookingLogic,getDatesBetween} from "../HelperFNs/Helper.Booking.js";
...
export const filter_all_rooms = async (req, res, next) => {
  try {
    ...
    // PLEASE PLEASE PLEASE don't change, ask me to change
...
//       { status: "available", room_capacity: { $eq: room_capacity } },
//       {
//         room_number: 1,
//         room_capacity: 1,
//         booked_on: 1,
...
//     res
//       .status(200)
//       .json({ msg: "List of available rooms", /*rooms,*/ available_rooms });
//   } catch (error) {
//     next(error);
//   }
// };
